...
namespace AppPrint_and_Wear.Controllers
{
    public class AdministradoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AdministradorId,Nombre,Apellidos,Contraseña,Telefono,Correo,Direccion,FechaNacimiento")] Administrador administrador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AdministradorId,Nombre,Apellidos,Contraseña,Telefono,Correo,Direccion,FechaNacimiento")] Administrador administrador)
        {
